...
bool Enemy::update()
{
    ...
    if(life == 0){
        physics.velocity.setY(3);
        physics.velocity.setX(3);
        auto imageComponent = get_component<ImageComponent>();
        SDL_SetTextureAlphaMod(imageComponent->m_texture, 120.0);
    }
